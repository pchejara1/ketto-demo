var fund = [
    ...
    {
     title : "Without treatment, I’ll lose my child to cancer. Help save her, donate",
     image : "https://kettocdn.gumlet.io/media/campaign/629000/629118/image/wid8aea26ce9cac7fd9f011df86c3904d347e6a40a2.jpg",
 ...
 function pass(arr){
    for(let val of arr){
     ...
     progress_Bar.append(progress_done);
      ...
      fbbtn.innerHTML = "<img src='https://img.icons8.com/fluency/2x/facebook.png' class='icon'/> &emsp;Share"
      fbbtn.setAttribute('id','fb-btn')

      let btn = document.createElement("button");
      btn.innerText = "Donate"
      btn.setAttribute('id','donate-btn')
       ...
       innerDiv.append(imageTag,titleTag,userLogo,raiser,raisedFund,textraised,progress_Bar,daysTag,text1,supportTag,text2,fbbtn,btn);
